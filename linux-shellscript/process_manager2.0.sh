...
#
#使用例子:
#用法1:先将脚本放于跟jar包相同目录下，进入jar目录执行：sh process_manager.sh 进程名 动作(start|stop|restart|status|info|deploy|fallback)
#	   如启动WTV3_Headquarters4V3进程命令:sh process_manager.sh start WTV3_Headquarters4V3.jar 
#	   如重启WTV3_Headquarters4V3进程命令:sh process_manager.sh restart WTV3_Headquarters4V3.jar 
#	   如部署WTV3_Headquarters4V3进程命令:sh process_manager.sh deploy WTV3_Headquarters4V3.jar WTV3_Headquarters4V3.jar@new
...
#      新增的部署方式,用于新旧jar包的名字不同(可能存在版本号不同),
#
#      如回退版本WTV3_Headquarters4V3进程命令:sh process_manager.sh fallback WTV3_Headquarters4V3.jar WTV3_Headquarters4V3.jar@20150331_14_30_12 
...
#     awk命令可以分割出PID($2部分)及Java主程序名称($2部分)
...
deploy(){
    ...
    if [ ! -f "$APP_HOME/$APP_JAR_NAME_NEW" ];then
        echo "======================================================================================"
        echo  "##deploy## WARNNING!! no new jar package need to deploy,the new jar package named by $APP_JAR_NAME_NEW  EXIT!"
        echo "======================================================================================"
        exit 1
    else
        echo  echo "======================================================================================"
        ...
        echo  echo "======================================================================================"
        echo  echo "======================================================================================"
        echo  "##deploy##shutdown the app named $APP_JAR_NAME"
        shutdown
        echo  echo "======================================================================================"
        
        APP_JAR_NAME=`echo $APP_JAR_NAME_NEW|cut -d '@' -f 1`
        mv -n $APP_JAR_NAME_NEW $APP_JAR_NAME
        echo  echo "======================================================================================"
        echo  "##deploy##start the app named $APP_JAR_NAME"
        start
        echo  echo "======================================================================================"
    fi
...
fallback(){
    ...
    if [ ! -f "$APP_JAR_BAK_HOME/$APP_JAR_NAME_NEW" ];then
        echo "======================================================================================"
        echo "##fallbackVersion## WARNNING!! the backup jar does not exist! $APP_JAR_BAK_HOME/$APP_JAR_NAME_NEW  EXIT!"
        echo "======================================================================================"
        exit 1   
    else
        APP_JAR_NAME_ORIGIN=`echo $APP_JAR_NAME_NEW|cut -d '@' -f 1`
        echo  "======================================================================================"
        mv -n $APP_JAR_NAME $APP_JAR_NAME@fallback
        echo  "##fallbackVersion##moved $APP_JAR_NAME to $APP_JAR_NAME@fallback"
        echo  "======================================================================================"
        
        echo  "======================================================================================"
        mv -n $APP_JAR_BAK_HOME/$APP_JAR_NAME_NEW $APP_JAR_NAME
...
case "$1" in
   ...
   'fallback')
     ...
     ;;
  *)
     echo "Usage: $0  {start|stop|restart|status|info|deploy|fallback} {Java old package name} [{Java prepare to run package name}]"
     exit 1
esac
exit 0
